...
@Component({
  selector: 'app-lista-reserva-material',
  templateUrl: './lista-reserva-material.component.html',
  styleUrl: './lista-reserva-material.component.css',
})
export class ListaReservaMaterialComponent implements OnInit {
  reservas: any[] = [];
  ...
  irParaEditar(id: number) {
    this.router.navigate(['/editar-reserva-material', id]);
  }
